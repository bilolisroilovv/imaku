  ...
  <div class="mycard">
    <div class="position-relative">
      ...
      <div class="product_favourite flex-center d-flex" >
        <ToggleFavorite title="Добавить в избранное" class="position-bottom-right mycard_favorite2 flex-center d-flex"/>
    ...
    <div class="d-flex align-items-center">
      <star-rating border-color="#fc8301" :border-width="1"  :star-points="[23,2, 14,17, 0,19, 10,34, 7,50, 23,43, 38,50, 36,34, 46,19, 31,17]" :star-size="11" inactive-color="transparent" active-color="#fc8301" :rating="4.5" text-class="custom-text" :read-only="true" :increment="0.5"></star-rating>
    </div>
    <!-- d-flex -->
    ...
    <div class="d-flex align-items-center mycard_store">
      <a href="shop.html" target="_blank" class="mycard_store_img mybg_center d-block"
        :style="{ 'background-image': 'url(' + this.image3 + ')' }">
      </a>
      <!-- mycard_store_img -->
      <a href="shop.html" target="_blank" class="mycard_store_name myhover_text text_ellipsis1"
