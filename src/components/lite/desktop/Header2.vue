  ...
  <header>
    <div class="mynavbar_inner">
      <div class="mygradient">
        <svg
          style="height: 0; top: 0; left: 0; width: 0; position: absolute; visibility: hidden;"
        >
          <linearGradient class="linear-gradient" id="gradient-start">
            <stop
              class="linear-gradient linear-gradient__stop-one"
              offset="0%"
              stop-color="#f55683"
            />
            <stop
              class="linear-gradient linear-gradient__stop-two"
              offset="100%"
              stop-color="#6d5bf5"
            />
          </linearGradient>
    ...
    >
      <div class="container">
        <div
          class="navbar_links myd-flex justify-content-between align-items-center pb-3 pt-2"
        ...
        <div class="d-flex myalign-items-center justify-content-between">
          <div class="d-flex myalign-items-center">
            ...
            <!-- header_categories -->
            <SearchGroup2 :scrollPosition="scrollPosition" />
          </div>
          <!-- d-flex -->
          <div>
...
export default {
  ...
  methods: {
    ...
    headerCategoriesDropdowntoggle() {
      this.headerCategoriesDropdownVisible = !this
        .headerCategoriesDropdownVisible;
    },
    onClose() {
